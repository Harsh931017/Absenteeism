...
namespace Absenteeism.Service
{
    public class MasterService : IMasterService
    {
        ...
        public MasterService(IMasterRepository masterRepository, IOptions<AppSettings> appSettings)
        {
        ...
        public async Task UpdateNotification(int UserId)
        {
            try
            {
                await _masterRepository.UpdateNotification(UserId);
            }
            catch (Exception ex)
            {
        ...
        public async Task<tblNotification> InsertNotification(int UserId, int AvailabilityId)
        {
            try
            {
                return await _masterRepository.InsertNotification(UserId, AvailabilityId);
            }
            catch (Exception ex)
            {
