...
namespace Absenteeism.Controllers
{
    ...
    public class MasterController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendNotification([FromBody] NotificationModel request)
        {
            try
            {
                var notification = await _masterService.InsertNotification(request);
                if (notification is null)
                {
                    return BadRequest(new ApiResponse<List<tblNotification>>
                    {
                        Succeeded = false,
                        Data = null,
                        Message = Constant.Messages.ErrorNotificationSend,
                        Outputcode = Enums.HttpStatusCode.BadRequest,
                        ResponseType = Constant.ResponseType.Error
                    });
                ...
                {
                    return Ok(new ApiResponse<List<tblNotification>>
                    {
                        Succeeded = true,
                        Data = notification,
                        Message = Constant.Messages.NotificationSend,
                        Outputcode = Enums.HttpStatusCode.OK,
                        ResponseType = Constant.ResponseType.Insert
                    });
                }
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode((int)Enums.HttpStatusCode.InternalServerError, new ApiResponse<List<tblNotification>>
                {
                    Succeeded = false,
                    Data = ex,
                    Message = Constant.Messages.InternalError,
        ...
        /// <summary>
        /// Get Notification List (Cell Member) Currently Under Testing
        /// </summary>
        /// <param name="UserId"></param>
        /// <returns></returns>
        [HttpGet(Constant.Routing.GetNotificationList)]
        //[Authorize(Roles = "Cell Member")]
        public async Task<IActionResult> GetNotificationList(int UserId)
        {
            try
            {
                ...
                var getNotification = await _masterService.GetNotification(UserId);

                return Ok(new ApiResponse<List<tblNotification>>
                {
                    Succeeded = true,
                    Data = getNotification,
                    Message = getNotification.Count() > 0 ? Constant.Messages.CommonSuccess : Constant.Messages.NoRecord,
                    Outputcode = Enums.HttpStatusCode.OK,
                    ResponseType = Constant.ResponseType.Insert
                });
            }
            catch (Exception ex)
            {
                ...
                await CommonFunctionSet.ErrorLog(ex, _appSettings.ConnectionStrings.MyConnections, "MasterController", "GetNotification");
                return StatusCode((int)Enums.HttpStatusCode.InternalServerError, new ApiResponse<List<tblNotification>>
                {
                    Succeeded = false,
                    Data = ex,
        ...
        /// <summary>
        /// Update Notification By user Id (Cell Member) Currently Under Testing
        /// </summary>
        /// <param name="UserId"></param>
        /// <returns></returns>
        [HttpPost(Constant.Routing.UpdateNotification)]
        //[Authorize(Roles = "Cell Member")]
        public async Task<IActionResult> UpdateNotification(int UserId)
        {
            try
            {
                var checkCellMember = await _masterService.CheckCellMember(UserId);
                ...
                var notifications = await _masterService.UpdateNotification(UserId);
                ...
                return Ok(new ApiResponse<List<tblNotification>>
                {
                    ...
                    Message = Constant.Messages.CommonSuccess,
                    Outputcode = Enums.HttpStatusCode.OK,
                    ResponseType = Constant.ResponseType.Update
                });
            }
            catch (Exception ex)
            {
                await CommonFunctionSet.ErrorLog(ex, _appSettings.ConnectionStrings.MyConnections, "MasterController", "UpdateNotification");
                return StatusCode((int)Enums.HttpStatusCode.InternalServerError, new ApiResponse<List<tblNotification>>
                {
                    Succeeded = false,
                    Data = ex,
