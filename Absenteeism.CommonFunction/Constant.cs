namespace Absenteeism.CommonFunction
{
    public class Constant
    {
        public static class Messages
        {
            ...
            public const string UserNotification = "User Notification is updated successfully";
            public const string NotificationSend = "Notification sent successfully";
            public const string ErrorNotificationSend = "Error sending notification";
        ...
        public static class Routing
        {
            ...
            public const string GetNotificationList = "GetNotificationList";
